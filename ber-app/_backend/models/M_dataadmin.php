...
{ 
	...
	/*-------------------- AWAL MODUL KOMISIONER ----------------*/
	public function indexkomisioner ($catid, $perPage, $uri)
	{
		$data = array();
        $this->db->select('*,komisioner.aktif as jangkrik');
        $this->db->from('komisioner'); 
		$this->db->join('users', 'users.username=komisioner.username', 'left'); 
		$this->db->join('jabatankomisioner', 'jabatankomisioner.id_jabatankomisioner = komisioner.id_jabatan', 'left');
		//$this->db->join('golongan', 'golongan.id_pangkat = komisioner.id_pangkat', 'left');
		//$this->db->where('aktif', 'Y');
        $this->db->order_by('jabatankomisioner.id_jabatankomisioner', 'asc');
		$getData = $this->db->get('', $perPage, $uri);
        if ($getData->num_rows() > 0)
            return $getData->result_array();
        else
	...
	public function pilihjabatankomisioner ()
	{
		$sql="select * from jabatankomisioner order by id_jabatankomisioner asc";
		$hslquery=$this->db->query($sql);
		return $hslquery;
	} 
	public function editkomisioner ($id)
	{
			$sql="SELECT * FROM komisioner WHERE id_komisioner='".$id."'";
			$hslquery=$this->db->query($sql);
			return $hslquery;
	}  
	
	/*-------------------- AKHIR MODUL KOMISIONER  ----------------*/
	...
	{
		$sql="select * from katprodukhukum order by urutan asc";
		$hslquery=$this->db->query($sql);
		return $hslquery;
	}  
	...
	/*-------------------- AWAL MODUL raperda  ----------------*/ 
	public function indexraperda ($catid, $perPage, $uri)
	{ 
		$data = array();
        $this->db->select('*,raperda.aktif as jangkrik');
        $this->db->from('raperda');
		//$this->db->join('katraperda', 'katraperda.id_katraperda=raperda.id_katraperda', 'left');
		$this->db->join('users', 'users.username=raperda.username', 'left'); 
	...
	public function editraperda ($id)
	{
		$sql="SELECT * FROM raperda WHERE id_raperda='".$id."'";
		$hslquery=$this->db->query($sql);
		return $hslquery;
	} 
	/*-------------------- AKHIR MODUL raperda  ----------------*/ 
	
	/*-------------------- AWAL MODUL propemperda  ----------------*/ 
	public function indexpropemperda ($catid, $perPage, $uri)
	{ 
		$data = array();
        $this->db->select('*,propemperda.aktif as jangkrik');
        $this->db->from('propemperda');
		//$this->db->join('katpropemperda', 'katpropemperda.id_katpropemperda=propemperda.id_katpropemperda', 'left');
		$this->db->join('users', 'users.username=propemperda.username', 'left'); 
	...
	public function editpropemperda ($id)
	{
		$sql="SELECT * FROM propemperda WHERE id_propemperda='".$id."'";
		$hslquery=$this->db->query($sql);
		return $hslquery;
	} 
	/*-------------------- AKHIR MODUL propemperda  ----------------*/ 
	
	/*-------------------- AWAL MODUL naskahakademik  ----------------*/ 
	public function indexnaskahakademik ($catid, $perPage, $uri)
	{ 
		$data = array();
        $this->db->select('*,naskahakademik.aktif as jangkrik');
        $this->db->from('naskahakademik');
		//$this->db->join('katnaskahakademik', 'katnaskahakademik.id_katnaskahakademik=naskahakademik.id_katnaskahakademik', 'left');
		$this->db->join('users', 'users.username=naskahakademik.username', 'left'); 
	...
	public function editnaskahakademik ($id)
	{
		$sql="SELECT * FROM naskahakademik WHERE id_naskahakademik='".$id."'";
		$hslquery=$this->db->query($sql);
		return $hslquery;
	} 
	/*-------------------- AKHIR MODUL naskahakademik  ----------------*/ 
	
	/*-------------------- AWAL MODUL buku  ----------------*/ 
	public function indexbuku ($catid, $perPage, $uri)
	{ 
		$data = array();
        $this->db->select('*,buku.aktif as jangkrik');
        $this->db->from('buku');
	...
	public function pilihjenisbuku ()
	{
		$sql="select * from jenisbuku order by id_jenisbuku asc";
		$hslquery=$this->db->query($sql);
		return $hslquery;
	}  
