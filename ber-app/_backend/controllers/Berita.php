...
function a_simpan()
    {
		...
		*/	
		/** E:CEK DATA **/ 
			...
			$isiberita=addslashes($this->input->post('isi_berita'));
			$judul=addslashes($this->input->post('judul'));
			$sub_judul=addslashes($this->input->post('sub_judul'));
			$text_foto=addslashes($this->input->post('text_foto'));
...
function a_edit()
    {
		...
		{  
			...
			$this->M_dataadmin->query_manual("UPDATE berita SET judul = '".$judul."',
