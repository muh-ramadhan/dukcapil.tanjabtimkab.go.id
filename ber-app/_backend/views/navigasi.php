            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
					...
					<li class="sidebar-search">
						...
						<li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Modul Berita & Artikel<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url(); ?>sambutan">Sambutan Kepala</a>
                                </li>
								<li>
					...
					<!--				<li>
						...
						<li>
                            <a href="#"><i class="fa fa-camera fa-fw"></i> Modul Foto Galeri<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url(); ?>fotoberita">Data Berita Foto</a>
                                </li> 
