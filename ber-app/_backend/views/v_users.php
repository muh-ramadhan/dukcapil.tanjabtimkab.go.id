						...
						<?php
							...
							<div style="border:1px solid #ec8585;background:#f2f2f2;border-radius:5px;padding:20px;margin-bottom:20px;">
								...
								<div class="form-group">
									<label>Blokir Users / Pengguna</label>
									<?php if ($raw['blokir'] == 'Y') { ?>
										<div class="radio"> <label> <input type="radio" name="blokir" id="aktifradios1" value="Y" checked>Ya </label> </div>
										<div class="radio"> <label> <input type="radio" name="blokir" id="aktifradios2" value="N">Tidak </label> </div>
									<?php } else { ?>
										<div class="radio"> <label> <input type="radio" name="blokir" id="aktifradios1" value="Y">Ya </label> </div>
										<div class="radio"> <label> <input type="radio" name="blokir" id="aktifradios2" value="N" checked>Tidak </label> </div>
									<?php } ?>
								</div>
							</div>
							...
							<div style="border:1px solid #ec8585;background:#f2f2f2;border-radius:5px;padding:20px;margin-bottom:20px;">
								...
								<br><br>
								<div class="form-group">
									<label>Tambahkan Hak Akses:</label>
									<div class="clearfix"></div>
									<?php
											$noo = 1;
