...
$('.case').attr("checked", "checked");
	$('#deleturut').attr('action', '<?php echo base_url(); ?>imageslide/urutall'); 
});

$('#buttondelet').click(function(){
	$('#deleturut').attr('action', '<?php echo base_url(); ?>imageslide/deleteall'); 
});   
...
<?php echo form_open_multipart('imageslide/a_simpan'); ?> 			
	...
	<div class="form-group">
				...
				<div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bell fa-fw"></i> Gambar Slide
                        </div> 
                        <div class="panel-body">
                            <div class="form-group">
