...
<!--		 <form action="<?php echo base_url(); ?>fotoberita/a_deleteall" method="POST">	-->	
	 ...
	 <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
									...
									<input type="checkbox" id="selectall"></th>	
                                            ...
                                            <th>Dibaca</th>
											<th>Publish</th> 
											<th>Tanggal Foto/Tanggal Upload</th>
											<th>Operator</th>
											<th>Edit</th>
                                        </tr>
                                    </thead>
	...
	?>
	   <tr class="odd">
			<td><?php echo $no; ?></td>
            <td><center><input type="checkbox" name="cek[]" class="case" value="<?php echo $row['id_fotoberita']; ?>" id="id<?php echo $no; ?>" rel="ck" title="Pilih"></center></td>
            <td><a class="bold" href="<?php echo base_url(); ?>fotoberita/edit/<?php echo $row['id_fotoberita']."/".$judul."/";?>"> <?php echo $row['judul_fotoberita']; ?> </a></td>
			...
			<!--<td></td>-->
			<td><?php echo tgl_indo($row['tanggal']); ?> / <?php echo tgl_indo($row['tgl_posting']); ?></td>
...
<input type="hidden" name="id" value="<?php echo seo_link($id); ?>"> 
	...
	-->
		...
		<div class="form-group">
			<label>Jumlah Foto Berita</label> 
