...
$('.case').attr("checked", "checked");
	$('#deleturut').attr('action', '<?php echo base_url(); ?>katprodukhukum/urutall'); 
});

$('#buttondelet').click(function(){
	$('#deleturut').attr('action', '<?php echo base_url(); ?>katprodukhukum/deleteall'); 
});   
    ...
    <link href="<?php echo base_url()?>style/bower_components/bootstrap-social/bootstrap-social.css" rel="stylesheet"> 
		 <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Kategori Produk Hukum</h1>
                </div> 
            </div>
		<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							<i class="fa fa-th-list fa-fw"></i> Kategori Produk Hukum Terbaru
                        </div> 
	...
	<br> 
					 <center> 
						...
						<a href="<?php echo base_url(); ?>katprodukhukum/add" class="btn btn-app btn-primary btn-xs radius-4">
							<i class="ace-icon fa fa-plus-circle bigger-160"></i> Add
						</a>
						
						<a href="<?php echo base_url(); ?>katprodukhukum" class="btn btn-app btn-warning  btn-xs  radius-4">
	...
	?>
	   <tr class="odd">
			<td><?php echo $no; ?></td>
            <td><center><input type="checkbox" name="cek[]" class="case" value="<?php echo $row['id_katprodukhukum']; ?>" id="id<?php echo $no; ?>" rel="ck" title="Pilih"></center></td>
            <td><a class="bold" href="<?php echo base_url(); ?>katprodukhukum/edit/<?php echo $row['id_katprodukhukum']."/".$judul."/";?>"> <?php echo $row['nama_katprodukhukum']; ?> </a></td>
			...
			<?php if ($row['jangkrik']=='Y') {?>
				<a href="<?php echo base_url(); ?>katprodukhukum/nonaktif/<?php echo $row['id_katprodukhukum']."/".$judul."/";?>" class="btn btn-info btn-circle btn-lg"><i class="fa fa-check"></i> </a>
			<?php } else {?>
				<a href="<?php echo base_url(); ?>katprodukhukum/aktif/<?php echo $row['id_katprodukhukum']."/".$judul."/";?>" 	class="btn btn-warning btn-circle btn-lg"><i class="fa fa-times"></i> </a>
			<?php } ?> 
			</td>
			  
            <td class="center"><?php echo $row['nama_lengkap']; ?></td>
            <td class="center">
				<a href="<?php echo base_url(); ?>katprodukhukum/edit/<?php echo $row['id_katprodukhukum']."/".$judul."/";?>" class="btn btn-block btn-social btn-dropbox">
					<i class="fa fa-pencil"></i> Edit
                </a> 
				
				<a href="<?php echo base_url(); ?>katprodukhukum/delete/<?php echo $row['id_katprodukhukum']."/".$judul."/";?>" class="btn btn-block btn-social btn-pinterest" onclick="return confirm('Apakah Anda benar-benar mau menghapusnya?')">
...
?>
 ...
 <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tambah Kategori Produk Hukum</h1>
                </div> 
            </div>
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							<i class="fa fa-wrench fa-fw"></i> Tambah Kategori Produk Hukum 
                        </div> 
                        <div class="panel-body"> 
							<?php echo form_open_multipart('katprodukhukum/a_simpan'); ?> 
						...
						<div class="clearfix"></div>
							...
							<div class="form-group">
								...
								<input  class="form-control" type="text" name="nama_katprodukhukum" value=""> 
							</div>
 ...
 <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Kategori Produk Hukum</h1>
                </div> 
            </div>
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							<i class="fa fa-wrench fa-fw"></i>Edit Kategori Produk Hukum 
                        </div> 
                        <div class="panel-body"> 
					<?php echo form_open_multipart('katprodukhukum/a_edit'); ?> 
					
		<?php
		$edit = $this->M_dataadmin->editkatprodukhukum($this->uri->segment(3,0)); 
		foreach($edit->result_array() as $raw)
		{ 
		?>
						<input type="hidden" name="id" value="<?php echo $raw['id_katprodukhukum']; ?>">  
						<div class="aksi" style="border-bottom:1px solid #ccc; margin-bottom:20px; ">
						<center>
						<button type="submit" class="btn btn-app btn-primary btn-xs radius-4">
							<i class="ace-icon fa fa-floppy-o bigger-160"></i> Save
						...
						<div class="clearfix"></div>
							...
							<div class="form-group">
								<label>Nama Kategori</label> 
								<input  class="form-control" type="text" name="nama_katprodukhukum" value="<?php echo $raw['nama_katprodukhukum']; ?>"> 
							</div>
