...
<!--		 <form action="<?php echo base_url(); ?>dokumen/a_deleteall" method="POST">	-->	
	...
	?>
	   <tr class="odd">
			<td><?php echo $no; ?></td>
            <td><center><input type="checkbox" name="cek[]" class="case" value="<?php echo $row['id_dokumen']; ?>" id="id<?php echo $no; ?>" rel="ck" title="Pilih"></center></td>
            <td><a class="bold" href="<?php echo base_url(); ?>dokumen/edit/<?php echo $row['id_dokumen']."/".$judul."/";?>"> <?php echo $row['judul']; ?> </a></td>
			<td>
			...
			<td><?php if ($row['jangkrik']=='Y') {?>
				<a href="<?php echo base_url(); ?>dokumen/nonaktif/<?php echo $row['id_dokumen']."/".$judul."/";?>" class="btn btn-info btn-circle btn-lg"><i class="fa fa-check"></i> </a>
			<?php } else {?>
...
<label>Link Dokumen</label> 	
		...
		if ($raw['metode_link']==1){
			...
			?><br>
			<a target="_blank" href="<?php echo base_url(); ?>../dokumens/<?php echo $pathdelete?>/<?php echo $raw['nama_file']; ?>"><?php echo $raw['nama_file']; ?> </a>
			<div class="clearfix"></div>
