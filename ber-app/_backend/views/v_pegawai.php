...
<div class="form-group">
	...
	<textarea id="loko" class="form-control" rows="6"  name="keterangan" ></textarea>
</div>						
...
<div class="form-group">
	<label>Keterangan</label> 
	<textarea id="loko" class="form-control" rows="6" name="keterangan" ><?php echo $raw['keterangan']; ?></textarea>
</div>					
