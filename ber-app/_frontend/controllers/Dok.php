...
class Dok extends CI_Controller {
	...
	{
		$data['deskripsi']="Dokumen Bagian Hukum Kab. Tanjung Jabung Timur - ".$this->M_data->titlesistem(1);	
		$data['judulapp']="Dokumen Bagian Hukum Kab. Tanjung Jabung Timur | ".$this->M_data->titlesistem(1);
		$data['judulan']="Dokumen Bagian Hukum Kab. Tanjung Jabung Timur"; 
