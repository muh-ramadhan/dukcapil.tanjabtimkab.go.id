...
class video extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['artikel'] = $this->m_data->allvideo($config['per_page'], $offset);
		
		$data['judulapp']="Video KPU Provinsi Jambi | ".$this->m_data->titlesistem(1);
		$data['judulan']="Video KPU Provinsi Jambi";
		$data['deskripsi']=$this->m_data->deskripsi(1);
		$data['keyword']=$this->m_data->keyword(1); 
		//$data["video"]=$this->m_data->allvideo(); 
