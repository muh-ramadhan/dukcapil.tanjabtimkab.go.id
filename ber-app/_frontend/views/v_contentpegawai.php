...
<td valign="top">
<table id="ver-zebra5">
<tbody><tr><td width="22%">Nama</td><td>:  <a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1,0)?>/detail/<?php  echo $row['id_pegawai'];?>/<?php echo $seo;?>"> 
...
<tr><td>Pangkat/Golongan</td><td>: <b><?php  echo $row['pangkat'];?> - <?php  echo $row['gol_ruang'];?> </b> </td></tr>
<tr><td>Jenis Kelamin</td><td>: <b><?php if ($row['kelamin']=='L') {?>
		Laki-laki
	<?php } else { ?> 
		Perempuan
		<?php }  ?></b> </td></tr>
<tr><td>TTL</td><td>: <b><?php if ($row['tempat']=='') {?>
		-
	<?php } else { 
		echo $row['tempat'];
		}  ?>
...
<tbody>
<tr><td width="200">Nama Lengkap</td>  <td width="500">: <strong> <?php echo $row->nama_pegawai;?> </strong></td> 
</tr> 
<tr><td width="200">Jabatan</td>  <td width="500">:  <?php echo $row->nama_jabatanpegawai;?>  </td></tr>
<tr><td >NIP</td>  
...
<tr><td>Masa Kerja</td>  <td> :  <?php echo $masa_tahun.' Tahun '.$masa_bulan.' Bulan'; ?></td></tr>
