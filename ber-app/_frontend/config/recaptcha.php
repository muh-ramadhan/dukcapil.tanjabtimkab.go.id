...
$config['recaptcha_sitekey'] = '6LdtzyETAAAAAEQ05MNWEHbY7ZpEOh78GxAp0ggL'; //ganti dengan site key yang didapat saat mendaftarkan website pada google recaptcha
$config['recaptcha_secretkey'] = '6LdtzyETAAAAAAPZqs-7QCt9XPeC8boAPJzMzfce'; //ganti dengan secret key yang didapat saat mendaftarkan website pada google recaptcha
$config['lang'] = "";
